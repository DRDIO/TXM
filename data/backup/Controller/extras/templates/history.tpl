	...
	<TR>
		...
		<TD WIDTH='579' VALIGN='top' STYLE='background: url(http://www.txmafia.com/extras/images/extras_main_body1.gif);'>
			<TABLE BORDER='0' CELLSPACING='0' CELLPADDING='0' STYLE='font: 12px Verdana;'>
				<TR>
					<TD>
						<IMG SRC='http://www.txmafia.com/extras/images/extras_main_history.gif' WIDTH='579' HEIGHT='32' BORDER='0'></TD>
				</TR>
			
				<TR>
					<TD STYLE='padding: 2px 11px 2px 11px;'>
						The adventure begins!</TD>
				</TR>
			</TABLE>
		</TD>
	</TR>
