...
{    
    ...
    if($type === 4 || $type === 13)
    {
        ...
        {
            $error = "Movie file must be under 8 MB.";
        }
    }
    else
    {
        $error = "Movie file must be (.SWF).";
    }
}
      ...
      function upload()
      {
            ...
            window.onload = function()
            {
                ...
                else if(success == "1")
                {
                    ...
                    status.innerHTML = "<strong>" + temp.value + "</strong><br />Movie file uploaded! <a href=\"\" onclick=\"return show_iframe('swf');\">Update?</a>";
